...
func (r *TopicRepository) Create(ctx context.Context, taskID int, topic *domain.Topic) (*domain.Topic, error) {
...
func (r *TopicRepository) List(ctx context.Context, offset, limit int) ([]*domain.Topic, error) {
...
func (r *TopicRepository) Update(ctx context.Context, id int, topic *domain.Topic) (*domain.Topic, error) {
